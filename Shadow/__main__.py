...
from Shadow import TOKEN, bot, dp
...
import_module("Shadow.modules.pm_menu")
# Import misc stuff
import_module("Shadow.utils.exit_gracefully")
...
import_module("Shadow.utils.db_structure_migrator")
