...
from Shadow import BOT_USERNAME, dp
from Shadow.config import get_bool_key
from Shadow.modules.error import parse_update
from Shadow.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Shadow.utils.filters." + module_name)
