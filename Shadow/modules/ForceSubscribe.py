...
__help__ = """
<b>ForceSubscribe</b>
- i can can mute members who are not subscribed your channel until they subscribe
- When enabled I will mute unsubscribed members and show them a unmute button. When they pressed the button I will unmute them

<b>Setup</b>
1) First of all add me in the group as admin with ban users permission and in the channel as admin.

<b>Note:</b> Only creator of the group can setup me and I will not allow force subscribe again if not done so.
 
<b>Commmands</b>
 - /forcesubscribe: To get the current settings.
 - /forcesubscribe <code>[no/off/disable]</code>: To turn off ForceSubscribe.
 - /forcesubscribe <code>[channel username]</code>: To turn on and setup the channel.
 - /forcesubscribe <code>clear</code>: To unmute all members who muted by me.
 
<b>Note:</b> <code>/forcesub</code> is an alias of <code>/forcesubscribe</code>
"""
