...
from Shadow.modules.utils.connections import chat_connection
from Shadow.modules.utils.language import get_strings, get_strings_dec
from Shadow.modules.utils.message import (
    InvalidTimeUnit,
    convert_time,
    get_args,
    need_args_dec,
)
from Shadow.modules.utils.restrictions import ban_user, kick_user, mute_user
from Shadow.modules.utils.user_details import get_user_link, is_user_admin
from Shadow.services.mongo import db
from Shadow.services.redis import bredis, redis
...
United: <code>Please send expiration time [...]</code>
Me: <code>5m</code> (5 minutes)
DONE!

- /setfloodaction <code>(action)</code>: Sets the action to taken when user exceeds flood limit
