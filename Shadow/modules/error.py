...
# Copyright (C) 2022 - 2021 Deshadeeth Thisarana
...
from Shadow import OWNER_ID, bot, dp
...
async def all_errors_handler(update: Update, error):
    ...
    text = "<u><b>united's Client Error...!</b></u>\n\n"
    text += "<b>Forward this to @tele_united_bots</b>\n\n"
    ...
    text += "<b>© 2020-2021 @tele_united_bots</b>"
