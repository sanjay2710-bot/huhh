...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["mynew_btn"], url="https://t.me/tele_united_bots"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utilising United's localization feature! 
...
United will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
