...
Also notes perfectly working in PM with me.

<b>Available commands:</b>
- /save <code>(name) (data)</code>: Saves the note.
- <code>#(name)</code> or /get <code>(name)</code>: Get the note registered to that word.
- /clear <code>(name)</code>: deletes the note.
- /notes or /saved: Lists all notes.
- /noteinfo <code>(name)</code>: Shows detailed info about the note.
- /search <code>(search pattern)</code>: Search text in notes
- /clearall: Clears all notes

<b>Only in groups:</b>
- /privatenotes <code>(on/off)</code>: Redirect user in PM to see notes
- /cleannotes <code>(on/off)</code>: Will clean old notes messages
...
Shadow can save notes from other bots, just reply /save on the saved message from another bot, saving pictures and buttons supported as well.
