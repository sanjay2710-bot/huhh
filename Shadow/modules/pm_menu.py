...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://telegra.ph/file/5f12d4ccf9ad5df413e2f.mp4"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            strings["bot_support"], url="https://t.me/tele_united_bots"
        ),
        InlineKeyboardButton(
            strings["united_group"], url="https://t.me/tele_united_bots"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "➕ Add me to your group ➕",
            url=f"https://telegram.me/unitedtg_bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/unitedtg_bott?start=help")
    )
    await message.reply(strings["help_header"], reply_markup=button)
