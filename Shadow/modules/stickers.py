...
from Shadow.services.events import register as Shadow
...
async def _(event):
    ...
    kanga = await event.reply(
        "Hello, This Sticker Looks Noice. Mind if i steal it"
    )
    ...
    if is_a_s:
        ...
        packshortname = f"Shadow_animated_{userid}"
